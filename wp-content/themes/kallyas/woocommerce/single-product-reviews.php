...
<?php if ( comments_open() ) : ?><div id="reviews"><?php
	...
	if ( $count > 0 ) :
		...
		echo '<h3 id="comments">'.__('Reviews', 'woocommerce').'</h3>';
	...
	if ( have_comments() ) :
		...
		echo '<p class="add_review"><a href="#review_form" class="inline show_review_form btn">'.__('Add Review', 'woocommerce').'</a></p>';
