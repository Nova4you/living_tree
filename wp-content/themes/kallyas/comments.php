...
<?php if ('open' == $post->comment_status) : ?>
	...
	<div id="respond">
		<h3 class="zn_com_title"><?php comment_form_title('Leave a Reply', 'Leave a Reply to %s' ); ?></h3>
		...
		<?php else : ?>
 		<div class="row">
			<div class="span3"><input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> class="span3" placeholder="<?php echo __("Name",THEMENAME);?> <?php if ($req) echo "(required)"; ?>" />

			</div>
			
			<div class="span3"><input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> class="span3" placeholder="<?php echo __("Mail (will not be published)",THEMENAME);?> <?php if ($req) echo "(required)"; ?>" />

			 </div>
			<div class="span2"><input type="text" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" class="span2" placeholder="<?php echo __("Website",THEMENAME);?>" />
