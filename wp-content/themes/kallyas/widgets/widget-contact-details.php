...
class ZN_Widget_Text extends WP_Widget {
	...
	function __construct() { 
		...
		$widget_ops = array('classname' => 'widget_text_contact', 'description' => __('This widget will display your content with a "Say Hello" image on the top right.'));

		$control_ops = array('width' => 400, 'height' => 350);

		parent::__construct('text_contact', __('['.THEMENAME.'] Contact Widget'), $widget_ops, $control_ops);
...
add_action( 'widgets_init', create_function( '', 'register_widget( "ZN_Widget_Text" );' ) );
