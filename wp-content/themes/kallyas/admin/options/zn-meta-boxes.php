...
add_action('init','zn_meta');
	global $all_icon_sets,$bootstrap_icons;
if (!function_exists('zn_meta')) {
	function zn_meta()
	{

	// Set the Options Array
	global $zn_meta_types;
	...
	$zn_meta_types = array( 
		...
		array( 	'title' =>  'Page Builder', 'id'=>'page_builder', 'page'=>array('page'), 'context'=>'normal', 'priority'=>'high' ),
		...
		array( 	'title' =>  'Portfolio Options', 'id'=>'portfolio_options', 'page'=>array('portfolio'), 'context'=>'normal', 'priority'=>'high' ),
						...
						"subelements" => array 
										(
											...
											array( 
												...
												"description" => "Please enter the video embed code here.",
												"id" => "sc_vb_embed",
												"std" => "",
												"type" => "text",
